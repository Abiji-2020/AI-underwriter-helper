            ...
            <CardContent className="px-0 flex flex-col gap-6">
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={(value) => handleChange('industry', value as Industry)}
                    >
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => handleChange('baseRate', Math.max(0, parseInt(e.target.value) || 0))}
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => handleChange('revenue', Math.max(0, parseInt(e.target.value) || 0))}
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => handleChange('yearsInBusiness', Math.max(0, parseInt(e.target.value) || 0))}
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => handleChange('priorClaims', Math.max(0, parseInt(e.target.value) || 0))}
                    />
                </div>
            </CardContent>
        </Card>

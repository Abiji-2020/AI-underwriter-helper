...
import { calculatePremium, RatingInputs, RatingResult } from '../utils/ratingLogic';
...
export const Dashboard: React.FC = () => {
    ...
    const [result, setResult] = useState<RatingResult>({ finalPrice: 0, trace: [] });
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8 flex-1 bg-gray-50 min-h-full">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 h-fit">
                <Assistant trace={result.trace} finalPrice={result.finalPrice} inputs={inputs} />
            </div>
        </div>
    );
};
